...
import ReviewWallSection from "@features/home/components/review-wall-section";
...
export default function HomeFeatureV2() {
  return (
    <main className="w-full overflow-x-visible bg-white text-black">
        ...
        <div className="relative h-125 sm:h-150 lg:h-175 w-full overflow-visible">
          ...
          >
            <video
              ...
              preload="none"
              poster="/hero.png"
              className="absolute inset-0 h-full w-full object-cover object-center z-0 will-change-transform"
            >
      ...
      >
        ...
        <motion.div
          className="max-w-7xl mx-auto mt-[clamp(2rem,4vw,3rem)] space-y-1"
        ...
        >
          <motion.p
            className="m-0 text-base leading-[1.72] text-black max-md:text-[0.9rem]! max-md:leading-[1.66]! max-[480px]:text-[0.84rem]!"
            variants={introParagraphVariants}
          >
            Welcome to Mimz Interiors, where timeless design meets spaces created
            to last a lifetime. At Mimz Interiors, we believe great design goes
            beyond aesthetics. It is about creating spaces that inspire comfort,
            elevate everyday living, and stand the test of time. Drawing inspiration
            from world-class interior design trends and adapting them to suit our
            client&apos;s needs, we deliver interiors that are elegant,
        ...
        >
          ...
          <div className="absolute inset-0 z-10 flex items-center justify-center px-6 text-center">
            <motion.div
              ...
              className="relative"
            >
              <blockquote className="p-0 font-bd-megalona text-[30px] font-normal italic leading-none text-white sm:text-[42px] md:text-[60px]">
              ...
              <div className="flex justify-center max-md:-mt-5 -mt-8">
                <Image
